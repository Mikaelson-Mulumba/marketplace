...
export default function EditKamuliUserPage() {
  ...
  const handleUpdateUser = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (res.ok) {
      alert("✅ Kamuli user updated successfully!");
        ...
        <main className="edituser-main">
          ...
          <form onSubmit={handleUpdateUser} className="edituser-form">
            ...
            >
              ...
              <option value="kamuli">Admin Kamuli</option>
              <option value="kamuliuser">Kamuli User</option>
            </select>

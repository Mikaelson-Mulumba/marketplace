    ...
    <div>
      ...
      <div className="products-container">
        ...
        <main className="products-main">
          <h1>🛒 Katwala Products Management</h1>
          <button
            onClick={() => router.push("/super/products/kampala/add")}
            className="btn-add"
          >
            ➕ Add Product
          </button>
            ...
            <tbody>
              {products.map((p) => (
                <tr key={p.id}>
                  ...
                  <td>{p.price}</td>
                  <td>
                    <button onClick={() => router.push(`/super/products/kampala/edit/${p.id}`)} className="btn-edit">Edit</button>
